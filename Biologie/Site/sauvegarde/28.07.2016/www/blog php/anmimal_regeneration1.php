...
<p>Amputation, in this picture decapitation, is the first step of the process in order to understand mechanisms of planarian regeneration. Indeed we will see how planaria’s body reacts. The accumulation of stem cells on the site of the injury forms what we call a <span id="blastema" style='color:blue;'>blastema</span>. It is this cluster of cells that will reproduce, regenerate, the missing body part.</p>
    <figure>
    	<img src="images/planeria2.0.jpg" title="Reference:  Tal Shomrat and Michael Levin, Tufts University"/>
    	<figcaption>Figure 3 : </figcaption>
    </figure>
<br/>
    
    <h4 id="regeneration_control">Control of the regeneration</h4>

    <p>Stem cells of the blastema receive different kind of signals, provided by hormones, which instruct them about the when and where of proliferation, differentiation and what cell lineage to adopt (turning into muscle, vasculature, nerve, epithelium, connective tissue, or others). There are many different hormones such as serotonin and dopamine, some of them are produced by muscle cells.</p>
    <figure>
...
<p>So, planarian flatworms seems to have a complete ability to regenerate themselves, even the head, but what about salamanders, can they regain memory as planarian ?</p>
    ...
    <p> The process begins with inflammatory response where blood vessels expand, allowing more blood to enter the injured zone. This in turn leads to an enhanced presence of white blood cells, neutrophils and lymphocytes, that enter the tissue and initiate the process of immune defence and tissue repair (figure 1). The ensuing inflammation is also responsable for the pain sensation, because macrophages produce chemical messengers that stimulate nociceptive nerves.</p>
    <figure>
    	<img src="images/12312359_527044340810067_709206265_n.jpg" alt="vasodilatation" title=""/>
    ...
    <p>The injury also causes the recruitment of Stem Cells, who are essential for the regeneration of the tissues.</p>
    <p>The mechanism responsible of Stem cell’s recruitment, globally referred to as the “injury signal” isn’t known yet, but may cytokines produced by the macrophages may play an important role (acting as chemo-attractants). Indeed, a studies performed by the Australian Regenerative Medecine Institute on salamanders, animals known for their capacity to regenerate entire anatomical structures, show that the macrophages play a role in the regeneration.</p>
    <p>Salamanders with macrophages normally regenerate a new member in about one year. Those that fail to recruit macrophages into the injured zone take much more longer to fully recover the lost body part. Salamanders totally lacking macrophages do not regenerate at all; these animals just manage to heal the wound by covering the body part with scar tissue.</p>
    <figure>
