...
"",-1E4,"/",location.hostname);tldc.tl_setCookie("_tls","",-1E4,"/",location.hostname);tldc.tl_setCookie("_tlv","",-1E4,"/",location.hostname);tldc.tl_loadAnalyticsCookies();tldc.params=tldc.tl_loadParamsCookie();tldc.tl_updateAnalyticsData()};
  ...
  if ( dUrl.match(/dons.pasteur.fr\/asso\/site\/ipa\/pasteurdon\/fr\/don\/confirmation/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/conv/605808.js"};
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/fseg/693.js?add=3456361"};
}
if ( dUrl.match(/dons.pasteur.fr\/asso/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/fseg/693.js?add=3456354"};
}
if ( dUrl.match(/arretezlesvirus/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/fseg/296.js?add=2380257"};
}
if ( dUrl.match(/stopvirus/i) ) {
	scriptArray[n++] = {"code":""};
}
scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=488034"};
scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=574816"};
scriptArray[n++] = {"src":"//cdn.tradelab.fr/conv/185196.js"};
